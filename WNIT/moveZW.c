#include	<md.h>
#include	<system.h>
#define 	FinalZwall	24.11147 /* Final value of zwall */
/*	This routine move the Z wall to a new position, calculate *
 *	the density of NIT, adjust the value of zwall, period.fz   *
 *	and iperiod.fz
 */
...
int *done;
{
/*	find the closest distance from a DCE molecule and zwall */
int index,i;
double minDis;
...
delta = 0.5*minDis; /* we move the walls by this distance*/
