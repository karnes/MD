/*
 *	The flag fields for the various atoms . . .
 */
#define	A_FIXED	0001
#define	A_MAJOR	0002
#define	A_DRAW	0004
...
/*
 *	Atom Type Codes.  Increment NTYPES, #define new name, and #define
 *	new mass-name if you want to add a new molecule type.
 */
...
/*	Define CCL4 type for the zrp system. */
#define CCL4		99	/* Unified CCl4 atom/molecule, for zrp. */
