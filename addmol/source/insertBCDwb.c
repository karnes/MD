...
//if(j==0)fprintf(stderr,"r = %f\n",r);
	if (r < rmax){
		if(inC[i]==0){
		   ...
		   fprintf(stderr,"error... exiting(indx). \n");
		   exit(0);
		}
	}
      }
...
//if(j==0)fprintf(stderr,"r = %f\n",r);
	if (r < rmax){
		if(inC[i]==0){
		   ...
		   fprintf(stderr,"error... exiting(BCD). \n");
		   exit(0);
		}
	}
      }
...
*/
//j = natoms - nWR * 3;
for (k=indx; k<indx+9; k++) {// print center BrO
		fprintf(fpo,
"%4d %3d  %12.5f  %12.5f  %12.5f   %04o  %4d %4d %4d\n",
k+i-indx,atom2[k].type,pos2[k].fx,pos2[k].fy,pos2[k].fz,atom2[k].flags,atom2[k].parent -indx + i,atom2[k].param1,atom2[k].param2);
}
i+=9;
for (k=natoms2-147; k<natoms2; k++) {// print BCD
		fprintf(fpo,
"%4d %3d  %12.5f  %12.5f  %12.5f   %04o  %4d %4d %4d\n",
k-(natoms2-147)+i,atom2[k].type,pos2[k].fx,pos2[k].fy,pos2[k].fz,atom2[k].flags,atom2[k].parent - (natoms2 - 147) + i,atom2[k].param1,atom2[k].param2);
}
