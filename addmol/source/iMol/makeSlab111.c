...
/*	Set dummy data for header   */
	...
	struct atom A = {113, edge*0.788675, edge*0.788675, edge*0.15470054, 1, 2, 3, 4};//A
	uCell[0] = A;
	struct atom B = {113, edge*0.0, edge*1.0, edge*0.0, 1, 2, 3, 4};//B
	uCell[1] = B;
	struct atom C = {113, edge*1.0, edge*0.0, edge*0.0, 1, 2, 3, 4};//C
	uCell[2] = C;
	struct atom D = {113, edge*0.3660254, 0.3660254, 0, 1, 2, 3, 4};//D
	uCell[3] = D;
	struct atom E = {113, edge*0.78867513, edge*0.78867513, edge*0.28867513, 1, 2, 3, 4};//E
	uCell[4] = E;
	
	double ax = 0.78867513;
	double ay = 0.78867513;
	
	struct atom a = {0, edge*ax, edge*ay, edge*0.72168784, 1, 2, 3, 4};//a or a'
	uCell[5] = a;
	struct atom b = {0, edge*0.44722285, edge*0.94722285, edge*0.038567, 1, 2, 3, 4};//b
	uCell[6] = b;
	struct atom c = {0, edge*0.84145228, edge*0.34145228, edge*0.25010814, 1, 2, 3, 4};//c
	uCell[7] = c;
	struct atom d = {0, edge*0.16895027, edge*0.98575027, edge*0.14433757, 1, 2, 3, 4};//d
	uCell[8] = d;
 ...
 */
	if ((fp = fopen("slab111.xyz", "w")) == NULL) {
