/*	This backup preserves a 20-June-2014 rewrite of the silica slab 
 *	construction. The only change from the previous version is moving 
 * 	an Oxygen atom so that each Si-O-H silicon atom has 3 O-Si-O bonds
 *	without going over a simulation boundary. 
 *
